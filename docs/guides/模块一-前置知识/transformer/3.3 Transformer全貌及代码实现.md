---
title: "3.3 Transformer全貌及代码实现"
description: "从原始 Encoder-Decoder 到 Decoder-only 架构演化全解析，附 PyTorch 从零实现完整 Transformer"
pubDate: 2026-03-31
category: "prerequisites"
order: 304
chapter: 3
tags: ["Transformer", "模型架构", "Encoder-Decoder", "Decoder-only", "PyTorch"]
---
...
- [2. 原始 Transformer：Encoder-Decoder 架构](#2-原始-Transformer：Encoder-Decoder-架构)
- [3. Encoder 内部结构详解](#3-Encoder-内部结构详解)
- [4. Decoder 内部结构详解](#4-Decoder-内部结构详解)
- [5. 架构演化：三条分岔路](#5-架构演化：三条分岔路)
- [6. Decoder-only：当前大模型的端到端结构](#6-Decoder-only：当前大模型的端到端结构)
- [7. 从配置文件看真实模型结构](#7-从配置文件看真实模型结构)
- [8. 三种架构的工程特性对比](#8-三种架构的工程特性对比)
- [9. PyTorch 代码实现：从零搭建 Transformer](#9-PyTorch-代码实现：从零搭建-Transformer)
- [总结](#📝-总结)
- [自我检验清单](#🎯-自我检验清单)
- [参考资料](#📚-参考资料)
...
<img src="/AIInfraGuide/images/Transformer.png" alt="Transformer原始架构（Encoder-Decoder）" style="max-width: 90%; display: block; margin: 0 auto;" />
...
<img src="/AIInfraGuide/images/encode-block.png" alt="Encoder Block" style="max-width: 60%; display: block; margin: 0 auto;" />
...
<img src="/AIInfraGuide/images/decoder-block.png" alt="Decoder Block" style="max-width: 60%; display: block; margin: 0 auto;" />
...
| Mask 类型 | 使用位置 | 形状 | 目的 |
|-----------|---------|------|------|
| 长度 Mask | Encoder 自注意力 | (b, enc\_len, enc\_len) | 屏蔽 Encoder padding |
| Causal Mask | Decoder 自注意力 | (b, dec\_len, dec\_len) | 防止看到未来 token |
| Cross-Attn Mask | Decoder Cross-Attention | (b, dec\_len, enc\_len) | 屏蔽 Encoder padding |
...
- [Attention Is All You Need (Vaswani et al., 2017)](https://arxiv.org/abs/1706.03762) — Transformer 原始论文，Encoder-Decoder 架构与正弦位置编码的完整描述
...
- [Sequence to Sequence Learning with Neural Networks (Sutskever et al., 2014)](https://arxiv.org/abs/1409.3215) — Encoder-Decoder 框架的奠基论文
- [Are Sixteen Heads Really Better than One? (Michel et al., 2019)](https://arxiv.org/abs/1905.10650) — 对多头注意力有效性的实验分析
...
- [PyTorch nn.MultiheadAttention](https://pytorch.org/docs/stable/generated/torch.nn.MultiheadAttention.html) — PyTorch 官方 Multi-Head Attention 实现文档
