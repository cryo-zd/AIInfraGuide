---
title: "1.3 CUDA 内存模型"
description: "本文详解全局内存、共享内存、寄存器、常量内存和统一内存的特性、适用场景及优化技巧"
pubDate: 2026-05-09
...
<img src="/AIInfraGuide/images/cuda内存模型.png" alt="CUDA programming model" style="max-width: 70%; display: block; margin: 0 auto;" />
...
<img src="/AIInfraGuide/images/合并访存与非合并访存对比.png" alt="CUDA programming model" style="max-width: 70%; display: block; margin: 0 auto;" />
